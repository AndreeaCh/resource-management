...
public class MongoDbSpringIntegrationTest {
    ...
    @Test
    public void test() {
        final SubUnit subUnit = new SubUnit("CJ","CJ", Collections.emptyList(), Collections.emptyList(), Instant.now().toString(), Instant.now().toString(), Instant.now().toString(), null);
